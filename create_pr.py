...
payload = {"title": "Fix for issue #29", "body": "Closes #29\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-29", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/bobinson/vulture/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
